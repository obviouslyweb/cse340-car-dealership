...
INSERT INTO vehicles (id, category_id, make, model, year, price, mileage, is_available, is_featured, description) VALUES
    ...
    (4, 2, 'Chrysler', 'Pacifica', 2019, 22400.00, 51000, TRUE, FALSE, 'A versatile minivan offering a 3.6L Pentastar V6 (287 hp) and Stow ''n Go seating that folds flat into the floor. Features Apple CarPlay, Android Auto, and available all-wheel drive.'),
