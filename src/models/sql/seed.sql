...
INSERT INTO vehicles (id, category_id, make, model, year, price, mileage, stock, is_featured, description) VALUES
    ...
    (3, 2, 'Honda', 'Odyssey', 2017, 19800.00, 63000, 1, TRUE, 'A family minivan with a 3.5L V6 engine (280 hp) and 9-speed automatic transmission. Seats up to 8 passengers with available tri-zone climate control, rear entertainment system, and Honda Sensing safety suite.'),
    (4, 2, 'Chrysler', 'Pacifica', 2019, 22400.00, 51000, 0, FALSE, 'A versatile minivan offering a 3.6L Pentastar V6 (287 hp) and Stow ''n Go seating that folds flat into the floor. Features Apple CarPlay, Android Auto, and available all-wheel drive.'),
    (5, 3, 'Toyota', 'Camry', 2020, 21900.00, 38000, 4, TRUE, 'A mid-size sedan with a 2.5L four-cylinder engine (203 hp) and 8-speed automatic transmission. Includes Toyota Safety Sense 2.0, dual-zone climate control, and a 8-inch touchscreen infotainment system.'),
    (6, 3, 'Honda', 'Civic', 2018, 16500.00, 55000, 2, FALSE, 'A compact sedan featuring a 1.5L turbocharged engine (174 hp). Known for its fuel efficiency, responsive handling, and a well-appointed interior with Honda Sensing standard across all trims.'),
    (7, 4, 'Ford', 'Explorer', 2016, 20100.00, 94000, 1, FALSE, 'A three-row SUV with a 2.3L EcoBoost four-cylinder engine (280 hp) and available 4WD. Seats up to 7 passengers with a hands-free liftgate, SYNC 3 infotainment, and a towing capacity of up to 5,000 lbs.'),
